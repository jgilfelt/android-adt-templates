...
public class ${DetailName}Fragment extends Fragment {
     ...
     */
    private DummyGeoContent.DummyItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = DummyGeoContent.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.${detail_name})).setText(mItem.toString());
        }
